...
<div type="button" class="content__item_del" style="margin-left:auto;">
    <button class="btn-primary button button--mimas justify-center py-2 px-4   font-medium rounded-md text-white " onclick="MuldeleteModal(this)" data-url="{{ $url }}" data-method="POST" data-target="commonModal">
        <span>Delete</span>
    </button>
</div>
</div>